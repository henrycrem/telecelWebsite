                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-sm-2 part1 d-flex align-items-center'>
                                <Link href="/"><Image src={Logo}  className='logo' style={{ width: '100px', height: '50px' }} /></Link>
                                {
                                        ...
                                        <ul className='list list-inline mb-0 headerTabs'>
...

                                            {
                                                context.isLogin === "true" ?
                                                    ...
                                                    <li className='list-inline-item'>
                                                        <Link href={'/signIn'} style={{backgroundColor: "red"}}>
                                                            <Button className="btn btn-g bg-red" style={{backgroundColor: "red"}}>Sign In</Button>
                                                        </Link>
                                                    </li>
